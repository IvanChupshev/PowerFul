         ...
         <div class="container">
            <div class="d-flex align-items-center justify-content-between">
               ...
               <div class="icons">
                  ...
                  ?>
                     <a href="app/logayt.php" class="icons-btn d-inline-block bag"><span class="icon-sign-out icon-user"></span></a><!--Выход-->
                  <?php
                  } else {
                  ?>
                     <a href="./login.php" class="icons-btn d-inline-block bag"><span class="icon-sign-in"></span>
                     </a> <!--Вход/регистрация-->
                  <?php
                  }
                  ?>
         ...
         <div class="container">
            <div class="row">
               <div class="col-md-12 mb-0">
                  ...
                  <strong class="text-black">Авторизация </strong>
               </div>
            </div>
         </div>
      </div>
...
.....................................................................................-->
      ...
      <div class="main">
         <div class="shop_top">
            <div class="container">
               <div class="row">
                  <div class="col-md-6 logaut1">
                     <div class="login-title">
                        <h4 class="title">Вход для клиентов</h4>
                        <div id="loginbox" class="loginbox">

                           <form action="../app/vhod.php" method="post" id="login-form">
                              <fieldset class="input">
                                 <p id="login-form-username">
                                    <label for="modlgn_username">*Адрес электронной почты</label>
                                    <input id="modlgn_username" type="text" name="login" class="inputbox" size="18" autocomplete="off">
                                 </p>
                  ...
                  <div class="col-md-6 logaut2">
                     <div class="login-page">
                        <h4 class="title">Впервые на сайте PowerFul?</h4>
                        <p class="txtlg">Создайте аккаунт PowerFul для того, чтобы получить доступ к спортивным добавкам по самым низким ценам в России + множество других преимуществ PF.</p>
                        <div class="button1">
                           <a href="register.php"><input type="submit" name="Submit" value="Продолжить"></a>
                        </div>
